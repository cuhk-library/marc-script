...
<xsl:stylesheet version="1.0" xmlns="urn:isbn:1-931666-22-9" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	xsi:schemaLocation="urn:isbn:1-931666-22-9 http://www.loc.gov/ead/ead.xsd" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
				...
				<xsl:choose>
					<xsl:when test="$bulkdate!=''">
						<marc:controlfield tag="008">
							<xsl:text>040320k</xsl:text><xsl:value-of select="substring-before($bulkdate, '-')" /><xsl:value-of select="substring-after($bulkdate,'-')" /><xsl:text>xx\\\\\\\\\\\\000\0\eng\d</xsl:text>
						</marc:controlfield>
					</xsl:when>
					<xsl:otherwise>
						<marc:controlfield tag="008">
