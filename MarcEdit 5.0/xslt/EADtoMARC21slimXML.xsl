...
<xsl:stylesheet version="1.0" xmlns:marc="http://www.loc.gov/MARC21/slim"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="marc">
    ...
    <xsl:template match="/ead">
        ...
        <marc:record>
            <marc:leader><xsl:text>01125cam a2200289 a 4500</xsl:text></marc:leader>
            <marc:controlfield tag="008"><xsl:text>040320u9999\\\\xx\\\\\\\\\u\\\\\\\\und\d</xsl:text></marc:controlfield>
                ...
                <xsl:if test="//unitid">
                    <marc:datafield tag="099" ind1="" ind2="">
                        <marc:subfield code="a"><xsl:value-of select="normalize-space(//unitid/.)" /></marc:subfield>
                    </marc:datafield>
                </xsl:if>

                <xsl:if test="//origination">
                    <marc:datafield tag="100" ind1="1" ind2="">
                        <marc:subfield code="a"><xsl:value-of select="normalize-space(//persname/.)" /></marc:subfield>
                    </marc:datafield>
                </xsl:if>
                ...
                <xsl:if test="archdesc/did/physdesc">
                    <marc:datafield tag="300" ind1="" ind2="">
                        <xsl:for-each select="archdesc/did/physdesc/extent">
                            <marc:subfield>
                                <xsl:attribute name="code"><xsl:value-of select="substring(@encodinganalog,5,1)" /></xsl:attribute>
                ...
                <xsl:if test="archdesc/arrangement">
                    <marc:datafield tag="351" ind1="" ind2="">
                        <marc:subfield code="a"><xsl:value-of select="normalize-space(archdesc/arrangement/.)" /></marc:subfield>
                    </marc:datafield>
                </xsl:if>
                    ...
                    <xsl:for-each select="archdesc/dsc/c01">
                        ...
                        <marc:datafield tag="505" ind1="0" ind2="0">
                            <marc:subfield code="t">
                                ...
                                <xsl:value-of select="normalize-space(did/unittitle/.)" /><xsl:text>, </xsl:text>
                        ...
                        <xsl:for-each select="c02">
                            <marc:datafield tag="505" ind1="0" ind2="0">
                                <marc:subfield code="g">
                                    ...
                                    <xsl:value-of select="normalize-space(did/container/.)" /><xsl:text> -- </xsl:text>
                                </marc:subfield>
                                <marc:subfield code="t">
                                    <xsl:value-of select="normalize-space(did/unittitle/.)" />
                                    <xsl:if test="did/unitdate/.!=''">
                                        <xsl:text>, </xsl:text><xsl:value-of select="normalize-space(did/unitdate/.)" /><xsl:text>. </xsl:text>
                                    </xsl:if>
                                </marc:subfield>

                                <xsl:if test="did/physdesc/extent">
                                    <marc:subfield code="g">
                                        <xsl:value-of select="normalize-space(did/physdesc/extent/.)" /><xsl:text>.</xsl:text>
                                    </marc:subfield>
                                </xsl:if>
                                <xsl:if test="did/physdesc/dimensions">
                                    <marc:subfield code="g">
                                        <xsl:value-of select="normalize-space(did/physdesc/dimensions/.)" /><xsl:text>.</xsl:text>
                                    </marc:subfield>
                                </xsl:if>
                            </marc:datafield>
                ...
                <xsl:if test="archdesc/relatedmaterial">
                    <marc:datafield tag="544" ind1="1" ind2="">
                        <marc:subfield code="a"><xsl:value-of select="normalize-space(archdesc/relatedmaterial/.)" /></marc:subfield>
                    </marc:datafield>
                </xsl:if>
                ...
                <xsl:if test="archdesc/custodhist">
                    <marc:datafield tag="561" ind1="" ind2="">
                        <marc:subfield code="a"><xsl:value-of select="normalize-space(archdesc/custodhist/.)" /></marc:subfield>
                    </marc:datafield>
                </xsl:if>
